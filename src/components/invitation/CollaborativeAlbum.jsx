...
import { isVideoMedia, listAlbumPhotos } from "../../services/albumService";
...
function PreviewPhoto({ photo }) {
  ...
  return isVideoMedia(photo)
    ? <video src={source} aria-label={`Video reciente de ${photo.author}`} muted controls playsInline preload="metadata" />
    : <img src={source} alt={`Fotografía reciente de ${photo.author}`} loading="lazy" decoding="async" />;
}
