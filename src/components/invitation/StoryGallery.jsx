    ...
    <section className="invitation-section story-section">
      ...
      >
          ...
          <AnimatePresence initial={false} custom={direction} mode="popLayout">
            <motion.figure
              ...
              initial={
                reduceMotion
                  ? false
                  : { opacity: 0, x: direction > 0 ? 70 : -70, scale: 0.97 }
              }
            ...
            >
              <img
                src={items[active]}
                alt={`Recuerdo de los novios ${active + 1} de ${items.length}`}
                draggable="false"
              />
        ...
        {items.length > 1 && (
          <>
            <button
              className="story-carousel__arrow story-carousel__arrow--prev"
              type="button"
              onClick={() => move(-1)}
            ...
            <button
              className="story-carousel__arrow story-carousel__arrow--next"
              type="button"
              onClick={() => move(1)}
